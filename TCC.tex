...
\title{Optimização Bayesiana}
\author{Douglas Braga \textbackslash{} Felipe Sales}
...
its\ldots{}
	...
	\renewcommand{\contentsname}{Tabela de Conteúdo} \renewcommand{\listfigurename}{Lista de Imagens} \renewcommand{\listtablename}{Lista de Tabelas}
% End of CII addition
%%
%% End Preamble
%%
...
\begin{figure}
\centering
\includegraphics[width=0.2\textwidth,height=\textheight]{images/bo.png}
...
\begin{figure}
\centering
\includegraphics[width=0.3\textwidth,height=\textheight]{images/gp.png}
