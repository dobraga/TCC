...
conhecidos são os: \emph{bagging}\footnote{Breiman (1996)} e
\emph{boosting}\footnote{Schapire (1999)}.

\hypertarget{bagging}{%
\subsubsection{Bagging}\label{bagging}}

O Random Forest é um algoritmo de Machine Learning que tem como base o
\emph{bootstrap aggregating}.\footnote{Breiman (2001)}
...
Algoritmo genérico do \emph{boosting}

\textbf{INPUT:} \(\mathcal{D}\) \(\xi\);\\
\textbf{OUTPUT:} ;\\
~\\
\textbf{IF} this\_is\_True:\\
\hspace*{0.333em}\hspace*{0.333em}do\_this;\\
\textbf{ELSE}\\
\hspace*{0.333em}\hspace*{0.333em}select B from input;\\
\hspace*{0.333em}\hspace*{0.333em}do something whith input;\\
\hspace*{0.333em}\hspace*{0.333em}\textbf{FOR EACH} \(a_i\) \textbf{in}
B\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}do
something with \(a_i\);
