...
Não existe uma combinação perfeita de hiperparâmetros e como existe uma
função que relacione os hiperparâmetros com uma função de erro não
conseguimos utilizar a técnicas mais conhecidas no ramo da otimização,
serão abordados alguns métodos de otimização hiperparamétrica.
