...
Na figura \ref{bo} pode-se observar, que neste caso, esta sendo considerado que não há incerteza de medição nos pontos observados represetados pelo $x$ no gráfico, as bandas representam um intervalo de confiança de 95%.\
