...
![Um exemplo do uso da otimização bayesiana em um problema de design de brinquedo 1D.](images/bo.png){height=50%, #fig:bo}

A imagem @#fig:bo mostram uma aproximação do processo Gaussiano (GP) da função objetivo sobre quatro iterações dos valores amostrados da função objetivo. A figura também mostra o função de aquisição nas parcelas sombreadas mais baixas. A aquisição é alta onde o GP
...
![[Retirada do livro de Kevin Murphy](https://github.com/probml/pmtk3/blob/30d7a1952f3979b16e92dbfa4cd1ce0e402cf7d8/docs/demoOutput/bookDemos/(15)-Gaussian_processes/gprDemoNoiseFree_02.png)](images/gp.png){height=50%}  
