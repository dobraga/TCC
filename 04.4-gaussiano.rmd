...
Como qualquer outra distribuição de probabilidade os processos gaussinaos também podem ser utilizados como distribuição a priori para uma conjunto de pontos no espaço.

### Otimização Bayesiana

A optimização bayesiana utiliza como priori o Processo Gaussiano com o vetor de médias 0 para facilitar as contas, porém, um fato interessante do processo gaussiano é que a média pode ser totalmente definida pela sua matriz de covariância.^[@bishop2012pattern]
